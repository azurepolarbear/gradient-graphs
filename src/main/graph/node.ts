 ...
 *
 * This file is a part of azurepolarbear's gradient graphs algorithmic art project,
...
export class Node {
    ...
    public get position(): P5Lib.Vector {
        const x: number = this.#coordinate.getX(CoordinateMode.CANVAS);
        const y: number = this.#coordinate.getY(CoordinateMode.CANVAS);
        return P5Context.p5.createVector(x, y);
    }
}
